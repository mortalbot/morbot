...
-❥ *${prefix}stickergif*
Enviar una imagen git, con una duración menor a 10 segundos y esperar a que morbot cree tu sticker con movimiento.
...
-❥ *${prefix}nulis*
Crear textos en un cuaderno. ejemplo : envia #nulis HOLA, y morbot creara una imagen con tu texto en una hoja de cuaderno.
...
*No es necesario hacer una donación, morbot es solo un experimento sin fines de lucro.*`
}
